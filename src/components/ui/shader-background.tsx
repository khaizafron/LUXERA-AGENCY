...
const fragmentShader = `
  ...
  vec4 cppn_fn(vec2 coordinate, float in0, float in1, float in2) {
    // layer 1 *********************************************************************
    buf[6] = vec4(coordinate.x, coordinate.y, 0.0 + in0, 0.0 + in1);
    buf[7] = vec4(0.0 + in2, sqrt(coordinate.x * coordinate.x + coordinate.y * coordinate.y), 0., 0.);
...
function ShaderPlane() {
  ...
  return (
    <mesh ref={meshRef} position={[0, 0.0, 0.0]}>
